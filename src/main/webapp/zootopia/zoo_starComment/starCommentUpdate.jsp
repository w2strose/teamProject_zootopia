...
<section style="height: 1500px;">
	...
	<form action="starCommentUpdateProc.jsp?r_number=<%=r_number %>" method="post">
	<table id="tablebreakDown">
	 	...
	 	<tr>
	 		...
	 		<td><input type="text" name="title"  size="70" maxlength="70" placeholder="<%=vo.getS_title()%>"></td>
	 	</tr>
	 	<tr align="center">
		<th>별점</th>
			<td>
		...
		<tr height="300">
			<td colspan="2">
				<textarea rows="20" cols="80" name="coment" placeholder="<%=vo.getS_coment()%>"></textarea>
			</td>
		</tr>
		<tr>
